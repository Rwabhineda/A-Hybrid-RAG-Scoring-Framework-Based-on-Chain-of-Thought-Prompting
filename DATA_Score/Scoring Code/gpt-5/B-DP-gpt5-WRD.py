...
OUTPUT_FILE = r"C:\Users\zzh69\Desktop\国际文书的法律化程度：基于检索增强生成技术（RAG）的文书条款评分方法\RAG Databases\Scoring Code\gpt-5\Test_Article-gpt5-WRD.jsonl"
EXCEPTION_LOG_FILE = r"C:\Users\zzh69\Desktop\国际文书的法律化程度：基于检索增强生成技术（RAG）的文书条款评分方法\RAG Databases\Scoring Code\gpt-5\Test_Article_exception_llm_output_noRAG.log"
