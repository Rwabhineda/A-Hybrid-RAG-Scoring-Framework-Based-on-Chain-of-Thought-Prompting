...
OUTPUT_FILE = r"C:\Users\zzh69\Desktop\国际文书的法律化程度：基于检索增强生成技术（RAG）的文书条款评分方法\RAG Databases\Scoring Code\gpt4o\Test_Article_scored.jsonl"
EXCEPTION_LOG_FILE = r"C:\Users\zzh69\Desktop\国际文书的法律化程度：基于检索增强生成技术（RAG）的文书条款评分方法\RAG Databases\Scoring Code\gpt4o\Test_Article_exception_llm_output_WRD_Zero-shot.log"
CHROMA_DIR = r"C:\Users\zzh69\Desktop\国际文书的法律化程度：基于检索增强生成技术（RAG）的文书条款评分方法\RAG Databases\RAG_Data\chroma_db"
